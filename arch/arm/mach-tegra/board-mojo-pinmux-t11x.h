/*
 * arch/arm/mach-tegra/board-mojo-pinmux-t11x.h
 *
...
static __initdata struct tegra_pingroup_config mojo_pinmux_common[] = {
	...
	GPIO_PINMUX(GMI_AD5, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_AD6, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_AD7, PULL_UP, NORMAL, INPUT, DISABLE),
	...
	GPIO_PINMUX(GMI_CS1_N, PULL_UP, NORMAL, INPUT, DISABLE),
...
static struct gpio_init_pin_info init_gpio_mode_mojo_common[] = {
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PG5, false, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PG6, false, 0),
