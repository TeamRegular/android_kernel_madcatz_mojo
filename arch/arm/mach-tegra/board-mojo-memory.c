...
static struct tegra11_emc_table e1545_h5tc4g63mfr_pba_T40S_table[] = 
{
	...
	},
	{
		...
		},
		{
			...
			0x00000000, /* EMC_DLI_TRIM_TXDQS0 */
			0x00000000, /* EMC_DLL_XFORM_ADDR1 */
			0x00058000, /* EMC_DLL_XFORM_ADDR2 */
	...
	},
	{
		...
		},
		{
			...
			0xa0f10f0f, /* EMC_AUTO_CAL_CONFIG */
			0x007f0010, /* EMC_DLL_XFORM_ADDR0 */
			0x00000909, /* EMC_XM2CLKPADCTRL2 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS0 */
			0x00000000, /* EMC_DLL_XFORM_ADDR1 */
			0x007f0010, /* EMC_DLL_XFORM_ADDR2 */
	...
	},
	{
		...
		},
		{
			...
			0xa0f10f0f, /* EMC_AUTO_CAL_CONFIG */
			0x0000000d, /* EMC_DLL_XFORM_ADDR0 */
			0x00000909, /* EMC_XM2CLKPADCTRL2 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS0 */
			0x00000000, /* EMC_DLL_XFORM_ADDR1 */
			0x0000000d, /* EMC_DLL_XFORM_ADDR2 */
			0x0000000a, /* EMC_DLL_XFORM_DQS1 */
			0x0000000a, /* EMC_DLL_XFORM_DQS2 */
			0x0000000a, /* EMC_DLL_XFORM_DQS3 */
...
static struct tegra11_emc_table samsung_k4b4g1646b_hyk0_T40S_table[] = 
{
	{
		0x42,       /* Rev 4.0.3 */
		12750,      /* SDRAM frequency */
	...
	},
	{
		...
		},
		{
			...
			0xa0f10f0f, /* EMC_AUTO_CAL_CONFIG */
			0x00000006, /* EMC_DLL_XFORM_ADDR0 */
			0x00000808, /* EMC_XM2CLKPADCTRL2 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS0 */
			0x00000000, /* EMC_DLL_XFORM_ADDR1 */
			0x00000006, /* EMC_DLL_XFORM_ADDR2 */
			0x00000008, /* EMC_DLL_XFORM_DQS1 */
			0x00000008, /* EMC_DLL_XFORM_DQS2 */
			0x00000008, /* EMC_DLL_XFORM_DQS3 */
	...
	},
	{
		...
		11,         /* number of up_down_regs */
		{
			...
			0xf00d0191, /* EMC_CFG_DIG_DLL */
			0x00008000, /* EMC_CFG_DIG_DLL_PERIOD */
			0x00008007, /* EMC_DLL_XFORM_DQS4 */
			0x00008007, /* EMC_DLL_XFORM_DQS5 */
			0x00008007, /* EMC_DLL_XFORM_DQS6 */
			0x00008007, /* EMC_DLL_XFORM_DQS7 */
			0x00000000, /* EMC_DLL_XFORM_QUSE4 */
			0x00000000, /* EMC_DLL_XFORM_QUSE5 */
			0x00000000, /* EMC_DLL_XFORM_QUSE6 */
			0x00000000, /* EMC_DLL_XFORM_QUSE7 */
		...
		},
		{
			...
			0x00008007, /* EMC_DLL_XFORM_DQS1 */
			0x00008007, /* EMC_DLL_XFORM_DQS2 */
			0x00008007, /* EMC_DLL_XFORM_DQS3 */
...
static struct tegra11_emc_pdata samsung_k4b4g1646b_hyk0_T40S_pdata = {
	.description = "samsung_k4b4g1646b_hyk0_T40S",
	.tables = samsung_k4b4g1646b_hyk0_T40S_table,
	.num_tables = ARRAY_SIZE(samsung_k4b4g1646b_hyk0_T40S_table),    
};


static struct tegra11_emc_pdata *mojo_get_emc_data(void)
{
    
    if (tegra_bct_strapping == 0) 
        return &samsung_k4b4g1646b_hyk0_T40S_pdata;
    else
	    return &e1545_h5tc4g63mfr_pba_T40S_pdata;
	
}

int __init mojo_emc_init(void)
{
	tegra_emc_device.dev.platform_data = mojo_get_emc_data();
