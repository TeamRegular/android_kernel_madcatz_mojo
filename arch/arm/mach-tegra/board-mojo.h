/*
 * arch/arm/mach-tegra/board-mojo.h
 *
...
#ifndef _MACH_TEGRA_BOARD_MOJO_H
#define _MACH_TEGRA_BOARD_MOJO_H
...
int mojo_regulator_init(void);
int mojo_suspend_init(void);
int mojo_sdhci_init(void);
int mojo_pinmux_init(void);
int mojo_sensors_init(void);
int mojo_emc_init(void);
int mojo_edp_init(void);
int mojo_panel_init(void);
int roth_panel_init(void);
int mojo_kbc_init(void);
int mojo_pmon_init(void);
int mojo_soctherm_init(void);
void mojo_sysedp_init(void);
void mojo_sysedp_core_init(void);
void mojo_sysedp_psydepl_init(void);
